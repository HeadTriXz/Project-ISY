...
public class MiniMax {
  ...
  /**
   * get the best next move for any given player based on the current game state. the game should be
   * advanced to the next player for it to work correctly. this function works using the current
   * board and does not work on a clone of the board because it uses the state of the game
   * determining the score of the board
   *
   ...
   */
  private int minimax(
      int depth, Player currentPlayer, int maxDepth, int color, int alpha, int beta) {
