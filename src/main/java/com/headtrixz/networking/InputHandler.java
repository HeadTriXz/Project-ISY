...
public class InputHandler implements Runnable {
  private final HashMap<ServerMessageType, ArrayList<Consumer<ServerMessage>>> listeners =
      new HashMap<>();
  private final HashMap<ServerMessageType, ArrayList<Consumer<ServerMessage>>> removed =
      new HashMap<>();
  ...
  /**
   * If there are any listeners for the given event, then for each listener, call the listener with
   * the given message.
   *
