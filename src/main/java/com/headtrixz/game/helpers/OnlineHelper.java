...
public class OnlineHelper implements GameModelHelper {
  ...
  public void initialize() {
    ...
    this.localPlayer =
        game.getPlayer(0) instanceof RemotePlayer ? game.getPlayer(1) : game.getPlayer(0);
  ...
  private final Consumer<ServerMessage> onMove =
      message -> {
  ...
  private final Consumer<ServerMessage> onDraw =
      message -> {
  ...
  private final Consumer<ServerMessage> onLoss =
      message -> {
        state =
            localPlayer.getId() == 1
  ...
  private final Consumer<ServerMessage> onWin =
      message -> {
        state =
            localPlayer.getId() == 1
                ? GameModel.GameState.PLAYER_ONE_WON
  ...
  private final Consumer<ServerMessage> onYourTurn =
      message -> {
