...
import helpers.MiniMaxTestCase;
...
class TestMiniMaxTestTicTacToe {
    ...
    Stream<DynamicTest> getMoveTest() {
        ...
        ArrayList<MiniMaxTestCase> testCases =
                Helpers.generateMiniMaxTestCases("src/test/resources/tictactoe.txt");
    ...
    void hashBoardAndPlayerTest() {
        ...
        for (int[] board : boards) {
            ...
            for (int i = 0; i < 2; i++) {
                ...
                assertFalse(hashes.contains(hash), "Hash function returned a duplicate hash.");
                hashes.add(hash);
            }
        }
    }
